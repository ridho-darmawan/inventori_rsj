                    ...
                    <?php if ($this->session->userdata('akses')=='1'): ?>
                        ...
                        <li>
                            <a href="<?= base_url('C_ruangan/index'); ?>">
                                <i class="fa fa-user"></i><span>RUANGAN</span>
                            </a>        
                        </li>

                        <li>
                            <a href="<?= base_url('C_databarang/index'); ?>">
                                <i class="fa fa-folder-open-o"></i><span>DATA BARANG</span>
                            </a>        
                        </li>
                        
                        <li>
                            <a href="<?= base_url('C_laporankerusakan/index') ?>">
                                <i class="fa fa-file"></i><span>LAPORAN KERUSAKAN</span>
                            </a> 
                        </li>
                        ...
                        <li>
                            <a href="<?= base_url('C_login/keluar') ?>">
